                            ...
                            <a href="{{route('admin.products')}}">
                                < {{ __('Back to List')}}</a>
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">{{ __('Product Description')}}</label>
                                        ...
                                        <input type="submit" name="saveButton" class="btn btn-danger mr-2" id="updateButton" value="{{ __('Delete')}}" />
                                    </form>
                                    @if($errors->any())
