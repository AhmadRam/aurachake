...
<div class="container-fluid">
    <div class="col-md-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{{ __('Add New Address')}}</li>
        </ul>
    </div>
</div>
<div class="container mb-50">
    ...
    <div class="col-md-12">
        <h4 class="urunDetayBaslik">{{ __('Add New Address')}}</h4>
        <form method="POST" action="{{ url(app()->getLocale(),'profile/add_address') }}/{{Auth::user()->id}}">
            {{csrf_field()}}
