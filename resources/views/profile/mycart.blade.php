...
<div class="container-fluid">
    <div class="col-md-12">
        <ul class="breadcrumb">
            ...
            <li><a href="{{url(app()->getLocale(),'profile/profile')}}">{{ __('Profile')}}</a></li>
...
<div class="container mb-30">
    <div class="col-md-12">
        ...
        <table class="table table-hover table-striped">
            ...
            <thead>
                <tr>
                    ...
                    <th>{{ __('Product')}}</th>
                    <th width="150" class="text-center">{{ __('Quantity')}}</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="rTableCell" id="deleteItem_{{$c[2]}}">
                            <button style="padding: 0;border: none;background: none;" class="delete_item" id="delete_item" value={{$c[2]}} name="delete_item"><i class="fa fa-times" style="color:red;"></i></button>
                        </div>
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <div class="rTableCell">
                            <button type="button" id="sub" value="{{$p->id}}" data-rel="{{$c[2]}}" data-rel2="{{$p->price}}" class="btn btn-xs btn-success sub">-</button>
                            ...
                            <button type="button" id="add" value="{{$p->id}}" data-rel="{{$c[2]}}" data-rel2="{{$p->price}}" class="btn btn-xs btn-success add">+</button>
                        </div>
                    </td>
                    <td class="text-center"> {{$p->price}}TL</td>
                    <td class="text-center">54,15 TL</td>
                    <td class="text-right">
                        <div id="individualPrice_{{$c[2]}}">
                            @php
                            $tot = $p->price* $c[1];
                            echo $tot;
                            @endphp
        ...
        @if($all != null)
            <a class="btn btn-primary pull-right" type="submit" href="{{ url(app()->getLocale()) }}/cart/confirm">{{ __('Checkout')}}</a>
        @endif
