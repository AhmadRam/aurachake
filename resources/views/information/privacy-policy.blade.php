...
<div class="container text-justify mb-30">
  <div class="col-md-12">
    ...
    <h2 class="urunDetayBaslik">{{ __('Privacy Policy')}}</h2>
    <div class='urunDetayAciklama'>
      <p>Mağazamızda verilen t&uuml;m servisler ve , www.aurachake.com.tr adresinde kayıtlı &nbsp;MCA Enerji Dan. İnş. TAAH. DIŞ. TİC. GIDA TAR. VE HAYV. LTD. ŞTİ.&nbsp;firmamıza aittir ve firmamız tarafından işletilir.&nbsp;</p>
